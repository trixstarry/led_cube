...
uint32_t patterns[10][5][3] PROGMEM = {
    ...
    {{0x4,0,0},{0x4,0,0},{0x4,0,0},{0x4,0,0},{0x4,0,0}},                                //6. Red Column 3 
    {{0x400,0,0},{0x400,0,0},{0x400,0,},{0x400,0,0},{0x400,0,0}},                       //7. RED Column 11
    {{0x4000,0},{0x4000,0,0},{0x4000,0,0},{0x4000,0,0},{0x4000,0,0}},                   //8. RED Column 15
    {{0x400000,0},{0x400000,0,0},{0x400000,0,0},{0x400000,0,0},{0x400000,0,0}},         //9. RED Column 23 
    {{0x80,0,0},{0x80,0,0},{0x80,0,0},{0x80,0,0},{0x80,0,0}},                           //10.RED Column 8
    {{0x800,0,0},{0x800,0,0},{0x800,0,0},{0x800,0,0},{0x800,0,0}},                      //11.RED Column 12
    {{0x1000,0,0},{0x1000,0,0},{0x1000,0,0},{0x1000,0,0},{0x1000,0,0}},                 //12.RED Column 13
    {{0x2000,0,0},{0x2000,0,0},{0x2000,0,0},{0x2000,0,0},{0x2000,0,0}},                 //13.RED Column 14
    {{0x20000,0,0},{0x20000,0,0},{0x20000,0,0},{0x20000,0,0},{0x20000,0,0}},            //14.RED Column 18
    ...
    {{0x739c0,0x739c0,0x739c0},{0x739c0,0x739c0,0x739c0},{0x739c0,0x739c0,0x739c0},{0x739c0,0x739c0,0x739c0},{0x739c0,0x739c0,0x739c0}},
